...
## [0.1.3](https://github.com/agentcontextdistributionprotocol/acdp-registry-rs/compare/acdp-registry-pg/v0.1.2...acdp-registry-pg/v0.1.3) - 2026-09-13
...
- *(pg)* make an absent Postgres a red run instead of 23 silent passes ([#228](https://github.com/agentcontextdistributionprotocol/acdp-registry-rs/pull/228))
