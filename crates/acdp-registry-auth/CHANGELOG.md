...
## [0.1.5](https://github.com/agentcontextdistributionprotocol/acdp-registry-rs/compare/acdp-registry-auth/v0.1.4...acdp-registry-auth/v0.1.5) - 2026-09-19
...
change. Nothing under `crates/acdp-registry-auth/` changed since 0.1.4.
...
single version (`version = { workspace = true }`), and other crates in it did
change. Nothing under `crates/acdp-registry-auth/` changed since 0.1.3.
